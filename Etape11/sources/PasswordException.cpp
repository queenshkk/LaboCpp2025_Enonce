...
void PasswordException::display() const{
	...
	switch(code)
  	{
	    case 1:
	        std::cout << "Taille du mdp doit être supérieur à 6"<< std::endl;
	      break;
	    case 2:
	        std::cout << "Le mdp doit contenir une lettre" << std::endl;
	      break;
	    case 3:
	        std::cout << "Le mdp doit contenir un chiffre" << std::endl;
	      break;
	    case 4:
	        std::cout << "Pas de mdp entré" << std::endl;
	      break;
  	}
